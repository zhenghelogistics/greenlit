...
| [0002](0002-cms-not-required-satisfies-gate.md) | CMS `NOT_REQUIRED` satisfies the empty collection gate | **Superseded by 0009** |
...
| [0008](0008-next-on-vercel.md) | Standard Next.js on Vercel, replacing vinext on Cloudflare Workers | Accepted |
| [0009](0009-cms-required-for-every-empty-collection.md) | CMS is required for every empty collection | Accepted, confirmed by operations |
