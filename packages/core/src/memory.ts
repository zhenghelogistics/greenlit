...
const CUSTOMERS: Customer[] = [
  { customerId: 'abc', code: 'ABC', companyName: 'ABC Company', shortName: 'ABC',
    ...
    emailDomains: ['abccompany.sg'], requiresPermit: false, accountStatus: 'ACTIVE', notes: null,
  ...
  { customerId: 'lct', code: 'LCT', companyName: 'Lion City Traders', shortName: 'Lion City',
    ...
    emailDomains: ['lioncity.sg'], requiresPermit: false, accountStatus: 'ACTIVE', notes: null,
  ...
  { customerId: 'mer', code: 'MER', companyName: 'Meridian Freight', shortName: 'Meridian',
    ...
    emailDomains: ['meridianfreight.com'], requiresPermit: false, accountStatus: 'ACTIVE', notes: null,
  ...
  { customerId: 'pep', code: 'PEP', companyName: 'PepsiCo International', shortName: 'PepsiCo',
    ...
    emailDomains: ['pepsico.com'], requiresPermit: false, accountStatus: 'ACTIVE', notes: null,
  ...
  { customerId: 'str', code: 'STR', companyName: 'Straits Cargo', shortName: 'Straits',
    ...
    emailDomains: ['straitscargo.sg'], requiresPermit: false, accountStatus: 'ACTIVE', notes: null,
