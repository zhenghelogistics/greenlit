...
export const toExportJob = (r: Record<string, unknown>): ExportJob => ({
  ...
  emptyCollectionDate: nn(r.empty_collection_date as string),
  emptyCollectionTime: nn(r.empty_collection_time as string),
...
export const toExportContainer = (r: Record<string, unknown>): ExportContainer => ({
  ...
  containerDetailsSentBy: nn(r.container_details_sent_by as string),
  containerDetailsReference: nn(r.container_details_reference as string),
